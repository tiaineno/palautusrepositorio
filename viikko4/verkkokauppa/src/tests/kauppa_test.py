...
class TestKauppa(unittest.TestCase):
    def setUp(self):
        ...
        def varasto_hae_tuote(tuote_id):
            ...
            if tuote_id == 2:
                return Tuote(2, "sandels", 1)
            if tuote_id == 3:
                return Tuote(3, "ketsuppi", 2)
    ...
    def test_tilisiirrolla_on_oikeat_parametrit(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_kahden_tuotetteen_osto_onnistuu(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_kahden_tuotteen_osto_onnistuu_kun_toista_ei_ole_varastossa(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_viitenumero_on_uniikki(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
